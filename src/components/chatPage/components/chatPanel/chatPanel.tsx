...
export function ChatPanel() {
  ...
  const [OpenStickerPanel, setOpenStickerPanel] = useAtom(openStickerPanelAtom);
  ...
  useEffect(() => {
    ...
    const handleMessage = (message: WSNewMessage) => {
      ...
      setResData((prevResData) => {
        ...
        return {
          ...prevResData,
          ChatMessages: [...prevResData.ChatMessages, message.message],
        };
      });
    };
      ...
      setResData((prevResData) => {
        ...
        return {
          ...
          ChatMessages: prevResData.ChatMessages.filter(
            (message) => message.MessageId != deletedMessage.deletedMessageId,
          ),
        };
      });
    };
      ...
      setResData((prevResData) => {
        ...
        return {
          ...
          ChatMessages: prevResData.ChatMessages.map((message) => {
            if (message.MessageId === updatedMessage.updatedMessageId) {
              return {
                ...message,
      ...
      <div className="chatPanelHeader">
        <div className="chatNameHeader">
          ...
          {resData?.IsGroup === false ? (
            <img
              src={
                GetMemberFields(currentUserId, resData?.ChatMembers)?.AvatarPath
              }
              alt="chatAvatar"
          ...
          <div className="ChatNameContainer">
            <p className="chatName">
              {resData?.IsGroup
                ? resData.ChatName
                : GetMemberFields(currentUserId, resData?.ChatMembers)?.Name}
            </p>
            {resData?.IsGroup && (
              <p className="membersCount">
                {resData && getMembersCountText(resData.ChatMembers.length)}
              </p>
            )}
          </div>
        </div>
